...
SYSTEM_PROMPT = (
    ...
    "To record project metadata: use write_metadata — it can only create/overwrite "
    "a project's top-level metadata.md (nothing else). It replaces the whole file, "
    "so read the current metadata.md first and pass the complete updated contents.\n"
